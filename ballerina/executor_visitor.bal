    ...
    *parser:Visitor;
    ...
    public isolated function visitField(parser:FieldNode fieldNode, anydata data = ()) {
        ...
        if fieldNode.getName() == SCHEMA_FIELD {
            ...
            if fieldNode.getArguments()[0].getValue() is parser:ArgumentValue {
                requiredTypeName = (<parser:ArgumentValue>fieldNode.getArguments()[0].getValue()).value.toString();
            } else {
                requiredTypeName = fieldNode.getArguments()[0].getName();
            }
