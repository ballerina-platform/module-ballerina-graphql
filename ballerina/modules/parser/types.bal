...
type SpecialCharacterType T_OPEN_BRACE|T_CLOSE_BRACE|T_OPEN_PARENTHESES|T_CLOSE_PARENTHESES|T_COLON|T_COMMENT|T_DOLLAR|T_EQUAL;
...
type LexicalType T_EOF|T_OPEN_BRACE|T_CLOSE_BRACE|T_OPEN_PARENTHESES|T_CLOSE_PARENTHESES|T_COLON|T_IDENTIFIER|T_STRING|
                 T_INT|T_FLOAT|T_BOOLEAN|T_ELLIPSIS|T_EQUAL|T_DOLLAR;
