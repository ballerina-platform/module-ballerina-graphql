...
isolated function getField(parser:FieldNode fieldNode, readonly & __Type fieldType, readonly & __Type parentType,
        readonly & string[] path, ServerCacheConfig? cacheConfig = ()) returns Field {
