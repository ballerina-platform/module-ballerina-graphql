...
public class CompilerPluginTest {
    ...
    public void testInvalidListTypeInputs() {
        ...
        diagnostic = diagnosticIterator.next();
        assertError(diagnostic, CompilationError.INVALID_RESOURCE_INPUT_OBJECT_PARAM, 44, 39);

        diagnostic = diagnosticIterator.next();
        assertError(diagnostic, CompilationError.INVALID_RETURN_TYPE_INPUT_OBJECT, 57, 5);

        diagnostic = diagnosticIterator.next();
        assertError(diagnostic, CompilationError.INVALID_RESOURCE_INPUT_OBJECT_PARAM, 73, 52);
    }
