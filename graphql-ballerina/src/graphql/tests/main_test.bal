...
//}
//function testShortHandQueryResult() returns @tainted error? {
//  string document = getDocumentForResourcesWithRecord();
//  var attachResult = gqlListener.__attach(serviceWithRecords);
//  json payload = {
//      query: document
//  };
//  http:Client httpClient = new("http://localhost:9091/serviceWithRecords");
//  http:Request request = new;
//  request.setPayload(payload);
//
//  json actualPayload = <json> check httpClient->post("/", request, json);
