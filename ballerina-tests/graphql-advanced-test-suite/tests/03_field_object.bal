...
function testFieldObject(string url, string documentFileName, string jsonFileName, string operationName) returns error? {
    ...
    json actualPayload = check common:getJsonPayloadFromService(url, document, operationName = operationName);
...
function dataProviderFieldObject() returns string[][] {
    ...
    string url1 = "localhost:9090/service_types";
    string url2 = "localhost:9090/service_objects";
