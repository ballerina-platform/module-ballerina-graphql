...
public enum ErrorMessage {
    ...
    ERROR_114("A GraphQL field type cannot be an input type"),
    ...
    ERROR_117("Interface types must have the distinct qualifier"),
    ERROR_118("All the resource functions in the interface class `{0}` must be implemented");
